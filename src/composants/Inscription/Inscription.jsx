                            ...
                            <div className="content-form">
                                <div className="direct-form row">
                                    ...
                                    <div className="focus col-md-11">
                                        <input id="yourname" name="nom" type="texte" placeholder='Nom'/>
                                    </div>
                                </div>
                                <div className="direct-form row">
                                    <div className="icone col-md-1">
                                ...
                                <div className="direct-form row">
                                    ...
                                    <div className="focus col-md-11">
                                        <input id="yourname" name="email" type="password" placeholder='Mot de passe'/>
                                    </div>
                                </div>
                                <div className="direct-form row">
                                    <div className="icone col-md-1">
                                    ...
                                    <div className="focus col-md-11">
                                        <input id="yourname" name="email" type="password" placeholder='Comfirmer mot de passe'/>
                                    </div>
                                </div>
                                <div className="send">
